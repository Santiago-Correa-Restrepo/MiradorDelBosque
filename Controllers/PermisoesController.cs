...
namespace Ultima.Controllers
{
    public class PermisoesController : Controller
    {
        ...
        public PermisoesController(BdGlampingFinalContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdPermiso,NomPermiso,PermisosSeleccionados,Estado")] Permiso permiso)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPermiso,NomPermiso,PermisosSeleccionados,Estado")] Permiso permiso)
        {
